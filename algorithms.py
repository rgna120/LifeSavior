...
def get_source(args):
    ...
    if args.video is None:
        ...
        #default is 0 for the webcam I changed it to 1 for the external webcam
        cam = cv2.VideoCapture("http://192.168.86.76:8000")
...
#                print("State prediction number: " + str(prediction))

# Checks if the prediction is fall and sends a message to phone stating that a fall has been detected
                if prediction == 0:
                    print(" you fell")
                    print("ABOUT TO SEND")
                    email_alert("IMPORTANT", "Help I have fallen", "8563797066@msg.fi.google.com")
                    print("SENT")
